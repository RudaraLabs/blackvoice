...
[![Tests](https://img.shields.io/badge/tests-139%20passing-black.svg)](tests/)
...
pytest -q                  # 139 tests, no microphone required
...
covered by 139 tests. The audio path — microphone capture, Vosk recognition,
