...
[![Tests](https://img.shields.io/badge/tests-151%20passing-black.svg)](tests/)
...
pytest -q                  # 151 tests, no microphone required
...
covered by 151 tests. The audio path — microphone capture, Vosk recognition,
